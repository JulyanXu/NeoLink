...
- 每 2 小时执行一次信息检查与刷新，覆盖首页时间、今日头条、最新新闻、核心指标、材料趋势，以及 MarketTrend 行情与舆情数据。
...
目标：
每 2 小时维护 NeoLink 新能源产业情报站的首页、最新新闻、今日头条、核心指标、材料趋势、站内详情页数据，以及 MarketTrend 行情与舆情索引。

执行规则：
1. 每 2 小时执行一次候选信息检查与数据刷新。
...
5. MarketTrend 的行情、个股、舆情证据、关键词和趋势每 2 小时尝试刷新一次；无可信数据变化时记录 no-change，不伪造行情。
